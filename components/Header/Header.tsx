...
function Header() {
  ...
  return (
    <div className="header-container z-50 sticky w-full top-0 flex justify-between bg-midnight text-white">
      ...
      <nav className={active ? "nav-bar active flex gap-10 self-center mr-10 flex-wrap overflow-hidden" : "nav-bar notactive flex gap-10 self-center mr-10 flex-wrap overflow-hidden"}>
